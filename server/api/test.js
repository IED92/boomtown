...
const resolvers = {
    Query: {
        ...
        person(root, args) {
            ...
            // find person with the person.id == id
        },
        movies() {
            return data.movies;
        },
    ...
    Person: {
        filmography(person) {
            return data.movies.filter(movie => {
                return person.filmography.includes(movie.id);
            });
            // console.log(person.filmography)
            // const id = person.filmography;
            // console.log(data.movies.filter(movie => movie.id === parseInt(id)));
            // return;
            // return data.movies.filter(movie => movie.id === parseInt(id));
        }
    },
    Movie: {
        stars(movie) {
            return data.people.filter(person => {
                return movie.stars.includes(person.id);
            });
        },
        director(movie) {
